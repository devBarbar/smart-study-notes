...
export const createStudyStyles = (palette: typeof Colors.light) =>
  StyleSheet.create({
    ...
    studyDetailsContent: {
      ...
      padding: Spacing.sm,
      borderTopWidth: 1,
      borderTopColor: `${palette.border}cc`,
    },
    canvasTitle: {
      flex: 1,
    },
    ...
    studySetupCard: {
      ...
      borderRadius: Radii.lg,
      borderWidth: 1,
      borderColor: `${palette.primary}36`,
      backgroundColor: palette.surfaceAlt,
      padding: Spacing.sm,
    },
    studySetupHeader: {
